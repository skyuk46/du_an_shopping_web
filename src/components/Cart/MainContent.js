...
function MainContent(props) {
  ...
  useEffect(
    function () {
      console.log("here", props.getCartDetail)
          ...
          : (productList && productList.length === 0)
            ? <div id="no-item-cart">
              ...
              <Button href="/" variant="contained" color="secondary">
                <Link style={{ textDecoration: "none", color: "white" }} to="/">Quay lại trang chủ</Link>
              </Button>
            </div>
            : <Row container id="cart-container">
              <Col span={8}>
                ...
                >
                  <div>
                    Bạn có chắc muốn xóa tất cả giỏ hàng không?
                  </div>
                </Modal>
                {
                  <div>
                    <div>
                      <Link style={{ textDecoration: "none" }} to="/"><Button id="continue-buying-button" variant="contained" color="secondary">Tiếp tục mua hàng</Button></Link>
              ...
              <Col span={4}>
                <Bill productList={productList} setOrderComplete={setOrderComplete} deleteAllCart={DeleteAllCart} />
              </Col>
            </Row>
      }
    </div>
